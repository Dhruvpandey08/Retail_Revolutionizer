...
export default function Navbar() {
  ...
  return (
    <>
        <nav className="font-Inter text-5xl shadow-md border-gray-100 border-b-2 flex flex-wrap justify-start items-center md:justify-center w-full py-4 md:py-0  text-gray-700  fixed z-0 opacity-90  top-0 bg-slate-50    ">
